...
Multiple real OpenCode agents can concurrently edit disjoint sections of the same
...
| Real agents used | prs.json | agent_mode per entry |
| PR #340–#359 created | prs.json | pr_url per entry |
